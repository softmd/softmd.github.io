...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181226_softportalit_5e7932ba9e92f47f4206_20190225121913_archive.zip';
	const ARCHIVE_SIZE		 = '72961849';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5e7932b-25121913';
	const VERSION			 = '1.3.8';
